...
{
    public partial class CitOfIdeas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Platform_PlatformId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Platform_PlatformId",
                        column: x => x.PlatformId,
                        principalTable: "Platform",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyEnabled", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyEnabled_Ideations_IdeationId",
                        column: x => x.IdeationId,
                        principalTable: "Ideations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Choice_Questions_MultipleChoiceQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChoiceAnswer_Answers_MultipleChoiceAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChoiceAnswer_MultipleChoiceAnswerId",
                table: "ChoiceAnswer",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyEnabled_IdeationId",
                table: "PropertyEnabled",
                column: "IdeationId");
